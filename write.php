        ...
        <hr>
            ...
            <div class="offset-md-2 col-md-8">
                <form action="write_submit.php" method="POST" id="blog">
                    ...
                    <div class="form-group">
                        <textarea name="comments" rows="15" cols="50" class="form-control" placeholder="Write Your Blog Here" name="message" form="blog"></textarea>
                    </div>
                    <div class="form-group">
                        <input type="submit" value="POST" class="btn btn-info" style="float: right;">
                    </div>
                </form>
            </div>
